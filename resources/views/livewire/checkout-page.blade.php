	...
	<div class="grid grid-cols-12 gap-4">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7">
				...
				<div class="mb-6">
					...
					<div class="mt-4">
						...
						<input wire:model="street_address" class="w-full rounded-lg border py-2 px-3" id="address" type="text">
						</input>
					...
					<div class="mt-4">
						...
						<input wire:model="city" class="w-full rounded-lg border py-2 px-3" id="city" type="text">
						</input>
						@error('city')
							<div class="text-red-500 text-sm">{{ $message }}</div>
						@enderror
					...
					<div class="grid grid-cols-2 gap-4 mt-4">
						<div>
							...
							<input wire:model="state" class="w-full rounded-lg border py-2 px-3" id="state" type="text">
							</input>
							@error('state')
							<div class="text-red-500 text-sm">{{ $message }}</div>
						    @enderror
						...
						<div>
							...
							<input  wire:model="zip_code" class="w-full rounded-lg border py-2 px-3" id="zip" type="text">
							</input>
							@error('zip_code')
							<div class="text-red-500 text-sm">{{ $message }}</div>
						    @enderror
		...
		<div class="md:col-span-12 lg:col-span-4 col-span-12">
			<div class="bg-white rounded-xl shadow p-4 sm:p-7">
				...
				<div class="flex justify-between mb-2 font-bold text-gray-700 mb-2">
					<span>
						Subtotal
					</span>
					<span>
