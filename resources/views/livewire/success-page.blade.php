          ...
          <div class="flex items-start justify-start flex-shrink-0">
            <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
              <div class="flex flex-col items-start justify-start space-y-2">
                ...
                <p class="text-sm leading-4 text-gray-600">{{ $order->address->city }}, {{ $order->address->state }} , {{ $order->address->zip_code }}</p>
                <p class="text-sm leading-4 cursor-pointer"> {{ $order->address->phone }} </p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="flex flex-col w-full space-y-6 ">
              ...
              <div class="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200">
                <div class="flex justify-between w-full">
                  ...
                  <p class="text-base leading-4 text-gray-600">{{ Number::currency($order->grand_total, 'LKR') }}</p>
                </div>
                <div class="flex items-center justify-between w-full">
                  <p class="text-base leading-4 text-gray-800">Discount
                  </p>
                  <p class="text-base leading-4 text-gray-600">{{ Number::currency(0, 'LKR') }}</p>
                </div>
                <div class="flex items-center justify-between w-full">
              ...
              <div class="flex items-center justify-between w-full">
                ...
                <p class="text-base font-semibold leading-4 text-gray-600">{{ Number::currency($order->grand_total, 'LKR') }}</p>
              </div>
            </div>
